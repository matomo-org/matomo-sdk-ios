Pod::Spec.new do |spec|
  spec.name         = "MatomoTrackerValley"
  spec.version      = "7.2.0-3"
  spec.summary      = "A Matomo Tracker written in Swift for iOS, tvOS and macOS apps."
  spec.homepage     = "https://github.com/valleyelectronics/matomo-sdk-ios/"
  spec.license      = { :type => 'MIT', :file => 'LICENSE.md' }
  spec.author       = { "Mattias Levin" => "mattias.levin@gmail.com", "Cornelius Horstmann" => "site-github@brototyp.de" }
  spec.source       = { :git => "https://github.com/valleyelectronics/matomo-sdk-ios.git", :tag => "v#{spec.version}" }
