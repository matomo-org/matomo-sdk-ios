...
final public class MatomoTracker: NSObject {
    ...
    @objc convenience public init(siteId: String, baseURL: URL, userAgent: String? = nil) {
        assert((baseURL.absoluteString.hasSuffix("piwik.php") || baseURL.absoluteString.hasSuffix("matomo.php")), "The baseURL is expected to end in piwik.php or matomo.php")
