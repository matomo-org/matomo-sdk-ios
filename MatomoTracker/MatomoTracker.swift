...
final public class MatomoTracker: NSObject {
    ...
    @objc public var isOptedOut: Bool {
        get {
            return MatomoUserDefaults.standard.optOut
        }
        set {
            MatomoUserDefaults.standard.optOut = newValue
        }
    }
    ...
    public var visitorId: String? {
        get {
            return MatomoUserDefaults.standard.visitorUserId
        }
        set {
            MatomoUserDefaults.standard.visitorUserId = newValue
...
extension MatomoTracker {
    ...
    public func startNewSession() {
        MatomoUserDefaults.standard.previousVisit = MatomoUserDefaults.standard.currentVisit
        MatomoUserDefaults.standard.currentVisit = Date()
        MatomoUserDefaults.standard.totalNumberOfVisits += 1
...
extension MatomoTracker {
    ...
    @objc public static var shared: MatomoTracker? {
    ...
    @objc public class func configureSharedInstance(withSiteID siteID: String, baseURL: URL, userAgent: String? = nil) {
        let queue = MemoryQueue()
        let dispatcher = URLSessionDispatcher(baseURL: baseURL, userAgent: userAgent)
        self._sharedInstance = MatomoTracker.init(siteId: siteID, queue: queue, dispatcher: dispatcher)
    }
    ...
    public class func configureSharedInstance(withSiteID siteID: String, queue: Queue = MemoryQueue(), dispatcher: Dispatcher) {
        self._sharedInstance = MatomoTracker(siteId: siteID, queue: queue, dispatcher: dispatcher)
    }
}
